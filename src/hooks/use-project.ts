...
import { addProject, createProjectFailure, createProjectsStart, createProjectSuccess } from "@/redux/slices/projects"
  ...
  const createProject = async (name?: string) => {
    ...
    try {
      ...
      dispatch(addProject({
        ...
        name: result.name,
        projectNumber: result.projectNumber ?? 0, // ✅ default fallback
        thumbnail,
